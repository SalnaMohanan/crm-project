      ...
      <Card className="shadow-lg border-0 rounded-4 overflow-hidden">
        ...
        <Card.Body className="p-4">
          ...
          <Row className="mb-3">
            <Col md={6}>
              <p className="fw-semibold">
                <strong className="text-muted">Begin Date:</strong> {new Date(campaign?.beginDate).toLocaleDateString()}
              </p>
            </Col>
            <Col md={6}>
              <p className="fw-semibold">
                <strong className="text-muted">End Date:</strong> {new Date(campaign?.endDate).toLocaleDateString()}
              </p>
            </Col>
          </Row>

          <p className="fw-semibold">
            <strong className="text-muted">Description:</strong> {campaign?.description}
          </p>
