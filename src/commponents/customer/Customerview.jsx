    ...
    <Container className="d-flex justify-content-center align-items-center vh-100">
      <Card className="shadow-lg p-4" style={{ width: "40rem" }}>
        <Card.Body>
          ...
          <Row className="mb-3">
            <Col xs={4}><strong>Source:</strong></Col>
          ...
          <Row className="mb-3">
            <Col xs={4}><strong>Company:</strong></Col>
            <Col xs={8}>{customerData.company || "N/A"}</Col>
          </Row>

          <Row className="mb-3">
            <Col xs={4}><strong>Industry:</strong></Col>
          ...
          <div className="d-flex justify-content-center mt-4">
            <Button
              variant="secondary"
              className="w-25"
              onClick={() => navigate(insideadmin ? "/user/customer" : "/customers")}
            >
              Cancel
            </Button>
          </div>
